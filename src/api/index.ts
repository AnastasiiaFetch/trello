      ...
      workspaces: [
        {
          ...
          description:
            'Це наш основний проект для розробки Це наш основний проект для розробки Це наш основний проект для розробки Це наш основний проект для розробки Це наш основний проект для розробки Це наш основний проект для розробки Це наш основний проект для розробки Це наш основний проект для розробки Це наш основний проект для розробки Це наш основний проект для розробки Це наш основний проект для розробки Це наш основний проект для розробки Це наш основний проект для розробки Це наш основний проект для розробки Це наш основний проект для розробки Це наш основний проект для розробки Це наш основний проект для розробки Це наш основний проект для розробки Це наш основний проект для розробки Це наш основний проект для розробки',
          members: [
            {
              id: '101',
              name: 'Іван Іванов',
